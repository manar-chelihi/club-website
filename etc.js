document.addEventListener("DOMContentLoaded", () => {
  ...
  ============================================================ */
  const cards = document.querySelectorAll(".etc-department-card");
  cards.forEach(card => {
  ...
  if (comments) {
    ...
    function renderComments() {
      comments.querySelectorAll(".etc-user-comment").forEach(c => c.remove());
  ...
  /* ============================================================
        3) AUTO POSTS SYSTEM (Admin → ETC page)
  ============================================================ */
  const postForm = document.getElementById("postForm");
  const postsContainer = document.getElementById("posts");
  const postsKey = "globalPosts";  // Same global key for all clubs
  ...
  ============================================================ */
  const trailContainer = document.getElementById("etc-trail-container");
  const colors = ["#ff0077", "#495a92ff", "#ffcc00", "#72b6d1ff", "#ff6600", "#9933ff"];

  if (trailContainer) {
    document.addEventListener("mousemove", (e) => {
      const dot = document.createElement("div");
      dot.classList.add("etc-trail");
